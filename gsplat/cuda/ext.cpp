...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("ortho_projection_2dgs_fused_fwd", &gsplat::ortho_projection_2dgs_fused_fwd);
    ...
    m.def(
        "rasterize_to_pixels_ortho_2dgs_fwd", &gsplat::rasterize_to_pixels_ortho_2dgs_fwd
    );
    m.def(
        "rasterize_to_pixels_ortho_2dgs_bwd", &gsplat::rasterize_to_pixels_ortho_2dgs_bwd
    );

    m.def("rasterize_to_indices_2dgs", &gsplat::rasterize_to_indices_2dgs);
    m.def("rasterize_to_indices_ortho_2dgs",&gsplat::rasterize_to_indices_ortho_2dgs);
