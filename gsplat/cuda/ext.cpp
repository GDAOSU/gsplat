...
TORCH_LIBRARY(gsplat, m) {
    ...
    m.def("ortho_projection_2dgs_fused_fwd(Tensor means, Tensor quats, Tensor scales, Tensor viewmats, Tensor Ks, int image_width, int image_height, float eps2d, float near_plane, float far_plane, float radius_clip) -> (Tensor, Tensor, Tensor, Tensor, Tensor)");
    m.def("ortho_projection_2dgs_fused_bwd(Tensor means, Tensor quats, Tensor scales, Tensor viewmats, Tensor Ks, int image_width, int image_height, Tensor radii, Tensor ray_transforms, Tensor v_means2d, Tensor v_depths, Tensor v_normals, Tensor v_ray_transforms, bool viewmats_requires_grad) -> (Tensor, Tensor, Tensor, Tensor)");
    ...
    m.def("ortho_projection_2dgs_packed_fwd(Tensor means, Tensor quats, Tensor scales, Tensor viewmats, Tensor Ks, int image_width, int image_height, float near_plane, float far_plane, float radius_clip) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor)");
    m.def("ortho_projection_2dgs_packed_bwd(Tensor means, Tensor quats, Tensor scales, Tensor viewmats, Tensor Ks, int image_width, int image_height, Tensor batch_ids, Tensor camera_ids, Tensor gaussian_ids, Tensor ray_transforms, Tensor v_means2d, Tensor v_depths, Tensor v_ray_transforms, Tensor v_normals, bool viewmats_requires_grad, bool sparse_grad) -> (Tensor, Tensor, Tensor, Tensor)");
    ...
    m.def("rasterize_to_pixels_ortho_2dgs_fwd(Tensor means2d, Tensor ray_transforms, Tensor colors, Tensor opacities, Tensor normals, Tensor? backgrounds, Tensor? masks, int image_width, int image_height, int tile_size, Tensor tile_offsets, Tensor flatten_ids) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor)");
    m.def("rasterize_to_pixels_ortho_2dgs_bwd(Tensor means2d, Tensor ray_transforms, Tensor colors, Tensor opacities, Tensor normals, Tensor densify, Tensor? backgrounds, Tensor? masks, int image_width, int image_height, int tile_size, Tensor tile_offsets, Tensor flatten_ids, Tensor render_colors, Tensor render_alphas, Tensor last_ids, Tensor median_ids, Tensor v_render_colors, Tensor v_render_alphas, Tensor v_render_normals, Tensor v_render_distort, Tensor v_render_median, bool absgrad) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor)");
    ...
    m.def("rasterize_to_indices_ortho_2dgs(int range_start, int range_end, Tensor transmittances, Tensor means2d, Tensor ray_transforms, Tensor opacities, int image_width, int image_height, int tile_size, Tensor tile_offsets, Tensor flatten_ids) -> (Tensor, Tensor)");
#endif
...
TORCH_LIBRARY_IMPL(gsplat, CUDA, m) {
    ...
    m.impl("ortho_projection_2dgs_fused_fwd", &gsplat::ortho_projection_2dgs_fused_fwd);
    m.impl("ortho_projection_2dgs_fused_bwd", &gsplat::ortho_projection_2dgs_fused_bwd);
    ...
    m.impl("ortho_projection_2dgs_packed_fwd", &gsplat::ortho_projection_2dgs_packed_fwd);
    m.impl("ortho_projection_2dgs_packed_bwd", &gsplat::ortho_projection_2dgs_packed_bwd);
    ...
    m.impl("rasterize_to_pixels_ortho_2dgs_fwd", &gsplat::rasterize_to_pixels_ortho_2dgs_fwd);
    m.impl("rasterize_to_pixels_ortho_2dgs_bwd", &gsplat::rasterize_to_pixels_ortho_2dgs_bwd);
    m.impl("rasterize_to_indices_2dgs", &gsplat::rasterize_to_indices_2dgs);
    m.impl("rasterize_to_indices_ortho_2dgs", &gsplat::rasterize_to_indices_ortho_2dgs);
#endif
