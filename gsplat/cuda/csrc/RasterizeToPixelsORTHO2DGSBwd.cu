...
void launch_rasterize_to_pixels_ortho_2dgs_bwd_kernel(
    // Gaussian parameters
    ...
    if (cudaFuncSetAttribute(
            rasterize_to_pixels_ortho_2dgs_bwd_kernel<CDIM, float>,
...
#define __INS__(CDIM)                                                          \
    template void launch_rasterize_to_pixels_ortho_2dgs_bwd_kernel<CDIM>(            \
